...
dir("data/offline/pan12")

#json_file <- "data/offline/pan12/ground-truth.json"


# Read data

data_all <- readRDS(file = "data/pan12/processed_data.rds")
...
testing_data <- readRDS(file = "data/pan12/unknown.rds")
names(testing_data)
